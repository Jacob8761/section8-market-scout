    ...
    >
      ...
      {vis && (
        <span style={{
          ...
          padding: '11px 14px', width: 290, fontSize: 12.5, color: '#cbd5e1',
          lineHeight: 1.65, zIndex: 9999, boxShadow: '0 10px 40px rgba(0,0,0,0.75)',
          pointerEvents: 'none', whiteSpace: 'pre-wrap',
          fontFamily: "'Inter',sans-serif", fontWeight: 400,
        }}>
          <span style={{
            display: 'block', color: '#60a5fa', fontWeight: 700, fontSize: 10.5,
